    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
      ...
      <nav className='w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex justify-between items-center z-50'> 
        ...
        <ul className='hidden md:flex items-center gap-6 lg:gap-8 rounded-full py-3 px-12 bg-white shadow-sm bg-opacity-50'>
            ...
            <li><a className='font-ovo' href="#projects">Mis proyectos</a></li>
        ...
        <div className='flex items-center gap-4'>
            ...
            <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4'>Contactame <Image src={assets.arrow_icon} className='w-3'alt=' '/></a>
